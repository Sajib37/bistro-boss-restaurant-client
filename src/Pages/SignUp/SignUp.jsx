...
const SignUp = () => {
    ...
    return (
        <section
            className=" min-h-screen flex items-center py-12 md:px-10 px-4 lg:px-0"
            style={{
        ...
        >
            ...
            <Toaster />
            <section
                className="w-full max-w-screen-xl border-2 px-1 md:px-4 mx-auto py-12 flex items-center flex-row-reverse gap-2"
                style={{
                    backgroundImage: `url(${bgImage})`,
                    backgroundSize: "cover",
                    boxShadow: "2px 2px 5px 5px #BBBCBD",
                }}
            >
                <img
                ...
                <section className="w-full lg:w-1/2  mx-auto px-2 md:px-4  md:w-2/3 lg:max-w-lg rounded-lg py-10 md:py-12">
                    ...
                    <form action="" onSubmit={handleRegisterForm}>
                        ...
                        <button
                            name="submit"
                            className="text-white bg-[#D1A054] py-2 w-full rounded-lg"
                        >
                            Register
                        </button>
                    </form>
                    ...
                    <p className="font-ubuntu font-medium mt-4">
                        ...
                        <Link className="text-[#D1A054] " to="/signIn">
                            Login
                        </Link>
                    </p>
